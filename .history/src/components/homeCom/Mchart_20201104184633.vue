    ...
    methods: {
        ...
        histogram() {
            axios.get('/api/homeData').then((res => {
                let gram = res.data.data;
                console.log(gram);
                this.columnChart.columns = Object.keys(gram[0]);
                console.log(this.columnChart.columns);
                this.columnChart.rows = gram
                console.log(this.columnChart.rows);
            })).catch((err => {
                console.log(err);
            }))
        }
