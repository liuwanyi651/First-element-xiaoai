...
<div class="all">
    ...
    <div class="mes">
        ...
        <div class="lie">
            ...
            <div class="tex">
                <countTo :startVal="startVal" :endVal="list.messages" :duration=" 3000">{{list.message}}</countTo>
            </div>
        </div>
    </div>
    <div class="money">
        ...
        <div class="lie">
            ...
            <div class="tex">
                <countTo :startVal="startVal" :endVal="list.purchases" :duration="3000">{{list.message}}</countTo>
            </div>
        </div>
    </div>
    <div class="cat">
