...
<div class="all">
    <div class="box">
        ...
        <div class="table" style="margin-bottom: 100px;" v-if="name === 1">
        ...
        <div class="table" style="margin-bottom: 100px;" v-if="name === 2">
        ...
        <div class="table" style="margin-bottom: 100px;" v-if="name === 3">
