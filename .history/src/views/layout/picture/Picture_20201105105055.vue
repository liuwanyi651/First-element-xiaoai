...
<div class="all">
    ...
    <div class="btn">
        ...
        <my-upload @crop-success="cropSuccess" @crop-upload-success="cropUploadSuccess" @crop-upload-fail="cropUploadFail" v-model="show" :width="200" :height="200" img-format="png" :size="size" langType=‘zh‘ :noRotate=‘false‘ field="Avatar1" <img :src="imgDataUrl">
    </div>
</div>
</template>
