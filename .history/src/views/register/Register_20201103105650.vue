    ...
    <div class="box">
        <div class="line">
            ...
            <el-form :model="loginForm" abel-width="0px" class="login-form">
                ...
                <el-form-item>
                    <!-- 首部图标 -->
                    <el-input v-model="loginForm.username" prefix-icon="iconfont icon-yonghuming" value="请输入用户名"></el-input>
                </el-form-item>
                <!-- 密码 -->
                <el-form-item>
                    <el-input v-model="loginForm.password" prefix-icon="iconfont icon-password" type="placeholder" value="请输入密码"></el-input>
                </el-form-item>
                <!-- 验证码 -->
                <el-form-item>
